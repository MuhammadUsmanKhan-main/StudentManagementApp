...
const admin_timetable_controller_1 = require("./admin.timetable.controller");
...
exports.TimetableModule = TimetableModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [timetable_controller_1.TimetableController, admin_timetable_controller_1.AdminTimetableController],
